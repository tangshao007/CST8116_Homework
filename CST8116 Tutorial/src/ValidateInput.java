/* 
	 ...
	 * Due Date: April 02, 2023 * Description: Assignment 02 (22W) Sample Solution  Update of original concept
...
public class ValidateInput {
	...
	/*
	 * This class provides utility for getting user input from the console using an
	 * instance of Scanner set to new Scanner(System.in)
	 */
	 ...
	 * calls method inputInteger() to get the actual input value.
	 */
	...
	/*
	 * This method prompts the user using the argument sent to message and then
	 * calls method inputDouble() to get the actual input value.
	 */
	 ...
	 * method inputString() which reads in the actual text.
	 */
	 ...
	 * down the program, rather than looping (in theory) forever. private access
	 * modifier prohibits use of method from outside of the class forcing the use of
	 * the method that accepts the String prompt in order to get the value.
	 */
	 ...
	 * encounters a line terminator character. private access modifier prohibits use
	 * of method from outside of the class forcing the use of the method that
	 * accepts the String prompt in order to get the value.
	 */
